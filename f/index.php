...
<body>
    ...
    <div class="information">
        <a href="http://cdn.bustdown.club/final-public.zip">download the cheat </a><br> <!-- cheat isnt out yet. just making things in preperation-->
</div>
    <center>
     <div class="resetpasswordbtn"> <!-- just used some already created class instead of making a new one zzz-->
        <p>current build: version 1.0</p><br>
     </div>
    <p>
